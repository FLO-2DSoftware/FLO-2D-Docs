...
A rainfall-runoff simulation was performed to estimate the watershed response to a design storm less than the 10yr event. 
...
where debris flows can be triggered by relatively frequent storm events (Staley et al, 2020).
