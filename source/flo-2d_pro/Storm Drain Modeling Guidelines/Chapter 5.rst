...
.. list-table::
   ...
   * - Elevations for outfall nodes.
     - THE STORM DRAIN OUTFALL INVERT ELEVATION SHOULD BE  EQUAL TO OR GREATER THAN THE FLOODPLAIN,

       CHANNEL, STREET ELEVATION.

       NO ACTION IS TAKEN.
       PLEASE REVIEW AND REVISE IF NECESSARY.

   * - Outfall node in channel interior element.
     - THE FOLLOWING STORM DRAIN OUTFALL NODES ARE IN CHANNEL INTERIOR ELEMENTS, RE-ASSIGN TO
   ...
   * - Grid element floodplain must be revised.
     - THE GRID ELEMENT FLOODPLAIN WAS REVISED DURING THE  SIMULATION TO THE STORM DRAIN INLET
   ...
   * - Horizontal type 4 storm drain inlet elevations.
     - THE HORIZONTAL TYPE 4 STORM DRAIN INLET ELEVATIONS  WERE REVISED DURING THE SIMULATION
   ...
   * - Type 4 inlet is a vertical inlet, and it is in a floodplain cell.
     - THE GRID ELEMENT ELEVATIONS IN "FLOODPLAIN  SWALES" WERE REVISED DURING THE SIMULATION
