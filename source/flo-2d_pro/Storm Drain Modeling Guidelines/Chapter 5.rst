...
.. list-table::
   ...
   * - Type 4 inlet is a vertical inlet,
     ...
     - THERE ARE VERTICAL TYPE 4 INLETS ASSIGNED TO CHANNEL ELEMENTS AND THE CHANNEL

       BED ELEVATION IS DIFFERENT  THAN THE INVERT ELEVATION.
   ...
   * - More than one storm drain inlet
   ...
   * - Missing storm drain inlet geometry
       ...
       simulation does not start.
     - THERE ARE A MISSING OR INAPPROPRIATE STORM DRAIN INLET  GEOMETRY IN FILE:
