...
5. Click **Next** and **Agree** to get to this window.  Check all options and click Next.
...
.. important:: The activator name tag is MM-YY where MM is the month and YY is the year of purchase. Don't run an activator
   from previous years.

.. image:: img/Instructions/inst002.png

2. Activation lasts 1 year past the purchase month.
