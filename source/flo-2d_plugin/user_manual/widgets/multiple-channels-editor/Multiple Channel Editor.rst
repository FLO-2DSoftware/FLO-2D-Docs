...
.. image:: ../../img/115-Multiple-Channel-Editor/mutipl002.png

2. The data is saved to
   the multiple channel global parameters table.

.. image:: ../../img/115-Multiple-Channel-Editor/mutipl002a.png
...
.. image:: ../../img/115-Multiple-Channel-Editor/mutipl004.png
...
.. image:: ../../img/115-Multiple-Channel-Editor/mutipl010.png


2. Use polylines to digitize the drainages,
   rills or gullies in the project area.

.. image:: ../../img/115-Multiple-Channel-Editor/mutipl011.png


3. This layer uses a global n-value attribute only so no spatial data is required for individual lines.

.. image:: ../../img/115-Multiple-Channel-Editor/mutipl012.png


4. Save and close the editor to commit the data to the geopackage using a sql trigger.
   This will automatically write the data to the Multiple Tables and assign the grid elements.

.. image:: ../../img/115-Multiple-Channel-Editor/mutipl013.png
...
.. image:: ../../img/115-Multiple-Channel-Editor/mutipl014.png
...
.. image:: ../../img/115-Multiple-Channel-Editor/mutipl008.png

2. The MULT.DAT file will be
   written the next time the project data is exported.

.. image:: ../../img/115-Multiple-Channel-Editor/mutipl015.png


.. image:: ../../img/115-Multiple-Channel-Editor/mutipl016.png

3. The data files are MULT.DAT and SIMPLE_MULT.DAT and can be reviewed in the Data Input Manual Build 22.

.. image:: ../../img/115-Multiple-Channel-Editor/mutipl017.png
