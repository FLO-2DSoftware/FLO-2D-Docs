...
.. note:: The street tool is not commonly used so it may not function as expected.  Modern models do not require this
          component because the grid cell size allows streets to be part of the overland grid.  If this
          tool is required for a project, contact us for development support.  Old project with streets will still function
          with the Grid Developer System (GDS).
