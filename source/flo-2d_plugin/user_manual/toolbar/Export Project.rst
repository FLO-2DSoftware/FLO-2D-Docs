...
.. image:: ../img/115-Buttons/exportproject.png


1. Set the Control Data switches before running the Export tool.
   See `Setup the FLO-2D Control Data <../toolbar/Control%20Variables.html>`__ step.
...
.. image:: ../img/115-Export-Project/exportproject2.png


4. Navigate to
   the project folder and click Select Folder.

.. image:: ../img/115-Export-Project/exportproject3.png
...
.. image:: ../img/115-Export-Project/exportproject4.png