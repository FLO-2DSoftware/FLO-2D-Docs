...
.. note::
   File naming varies across builds (for example, TIMEDEP.OUT vs TIMDEP.OUT). This page
   maps switch intent and output type by build.
...
- XSEC: cross-section output written from time series output (TIMDEPXSEC)
...
.. list-table::
   ...
   * - Builds 23–24
     ...
     - 0: none; 1: OUT+NC4.OUT; 2: HDF5; 3: NC-HDF5; 4: all; 5: CELL; 6: HDF5 only
       Interval variants: 11/21/31/41/51 apply the same intent for a time interval
...
.. list-table::
   ...
   * - 11/21/31/41/51
     ...
     - n/a
     - n/a
     - Interval variants of 1/2/3/4/5 (Build 25 adds XSEC to 31)

.. mermaid::

   flowchart TB

     A[ITIMTEP quick selector] --> B{Build family}

     B --> B16[Build 16]
     B --> B1819[Builds 18–19]
     B --> B21[Build 21]
     B --> B2325[Builds 23–25]

     B16 --> S16[0–4]
     S16 --> O160[0 none]
     S16 --> O161[1 OUT]
     S16 --> O162[2 OUT + HDF5]
     S16 --> O163[3 OUT + NETCDF4]
     S16 --> O164[4 all outputs]

     B1819 --> S1819[0–5]
     S1819 --> O185[5 CELL (TIMDEPCELL.DAT)]

     B21 --> S21[0–7]
     S21 --> O216[6 HDF5 only]
     S21 --> O217[7 NC-only output]

     B2325 --> S2325[0–6 + interval 11/21/31/41/51]
     S2325 --> O231[1 OUT + NC4.OUT]
     S2325 --> O232[2 HDF5]
     S2325 --> O233[3 NC-HDF5]
     S2325 --> O234[4 all outputs]
     S2325 --> O235[5 CELL (TIMDEPCELL.DAT)]
     S2325 --> O236[6 HDF5 only]
     S2325 --> I23[11/21/31/41/51 same intent for interval]
     B2325 --> X25[Build 25: XSEC added to 3 and 31]
